...
extern astra_rt_oob
astra_a1_09_pipeline_operator__inc__int32:
    push rbp
    mov rbp, rsp
    sub rsp, 16
    mov rax, rdi
...
astra_a1_09_pipeline_operator__double__int32:
    push rbp
    mov rbp, rsp
    sub rsp, 16
    mov rax, rdi
...
main:
    ...
    pop rdi
    sub rsp, 8
    call astra_a1_09_pipeline_operator__inc__int32
    add rsp, 8
    pop rdi
    movsxd rax, eax
    mov dword [rdi], eax
    ...
    pop rdi
    sub rsp, 8
    call astra_a1_09_pipeline_operator__double__int32
    add rsp, 8
    pop rdi
    movsxd rax, eax
    mov dword [rdi], eax
