...
extern astra_rt_oob
astra_a2_09_function_overloading__show__int32:
    push rbp
    mov rbp, rsp
    sub rsp, 16
    mov rax, rdi
...
astra_a2_09_function_overloading__show__string:
    push rbp
    mov rbp, rsp
    sub rsp, 16
    mov rax, rdi
...
main:
    ...
    push rax
    pop rdi
    call astra_a2_09_function_overloading__show__int32
    lea rax, [rel LC0]
    push rax
    pop rdi
    call astra_a2_09_function_overloading__show__string
    mov rax, 0
    movsxd rax, eax
    jmp .Lreturn_2
.Lreturn_2:
