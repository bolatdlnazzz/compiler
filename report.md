...
```text
A.1.7  — автоматический вывод типов 5
A.1.10 — if-выражение 5
A.1.11 — конвейерный оператор |> 5
A.1.13 — sizeof/typeid/typeof 5 
A.1.15 — блочные комментарии 5
A.2.8  — перегрузка функций 10 
A.2.9  — default-параметры и named arguments 10
A.2.12 — методы структур и public/private 10
A.2.20 — модули 10 
A.3.1  — перегрузка с неявными приведениями 20 
